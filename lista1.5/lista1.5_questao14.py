...
#
# 14. Faça um programa que receba o ano de nascimento de uma pessaoa e o ano atual, calcule e mostre:
...
try:
    ...
    e = c * 365
    f = c * 48
    print ('A subtração: ',a,'  - ',b,' é igual a : ',c,' que é a idade da pessoa em anos')
